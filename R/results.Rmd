...
marker<-data[(iteration %% 10 ==0  | eigenvector == 'Eigenvector 1' & iteration %in% c(2,4,6,8)) & eigenvector %in% c('Eigenvector 1',  'Eigenvector 3', 'Eigenvector 10')]
...
ggsave(file=paste0('/home/anne/Documents/featurecloud/singular-value-decomposition/results/plots/convergence_',ds,'.pdf'), width = 18, units = 'cm', height = 8)
```
```{r, echo=FALSE, warning=FALSE}
